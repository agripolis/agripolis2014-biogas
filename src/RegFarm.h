...
protected:
    ...
    */
    ...
    /**   @param var initial hectarage of arable or grassland land
          @param l number of plots of type specified in input file
    */
    void    setInitialLand(double* var, double l);
...
public:
    ...
    */
    ...
    void setInitialWithdrawal(double);
    ...
    double getAvLandRentOfFarmOfType(int) const;
