...
public:
    ...
    */
    ...
    /// return numbe of investments of invest type
    int getNewInvestmentsOfType(int t);
    ...
    */
    ...
    /** depreciate all investment objects
        ...
        rate. This was implemented because of investment intrest subsidies.
