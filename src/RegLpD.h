...
protected:
    ...
    */
    ...
    /** number links are all links which are neither connected
        to an object, nor a particular variable in the programme.
        They cover all restrictions and activities, which are only
        present in the MIP. These are in the KennAGENDA-Szenario
        \begin{itemize}
            \item winter fodder
            \item intensive grass
            \item extensive grass
            \item fertilisation
            \item raps 10%
            \item sugar beet quota
            \item set aside
            \item premium
        \end{itemize}
        In other szenarios, other restriction, such as GV are added
        to the list.
    */
