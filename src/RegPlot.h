...
public:
    ...
    */
    ...
    /** compute distance between plot and plot P
        @return d distance to farm agent
        The distance returned is without dimension. It is
        calculated as e.g. go three plots to the left and move
        up 5
    */
    /** identify whether plot has neighbours belonging to the
        same farm
    */
    int getId() {
        return plot_id;
