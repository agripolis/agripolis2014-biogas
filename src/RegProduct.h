...
public:
	//soil service
	void setSoilservice(double, double, double, double, double, int, bool, bool, double, double, double, double); //initialize
    ...
    /** Set variables with file input values
        ...
        @param c farm class
    */
    void setAttrib(int cn,int pt,int pg,string n,string c);
    // Debugroutine
    // Liefert String mit Beschreibung
    string debug();
