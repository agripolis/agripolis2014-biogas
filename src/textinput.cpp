      ...
      case 0:
        ...
        case 2:
              ...
              if (tt.compare("SOILS")==0) {
               ...
               else printf("WARNING: SOILS ? in %s \n", ENVIRONFILE);
               break;
          case 3 :
              iss >> t1;
              tt = t1;
...
void readmarket() {
    ...
    while (!ins.eof()){
        ...
        if (str1[0]=='!') {
            int i=0;
            while ( is >> str1) {
                if (!(str1.compare("TYPE") && str1.compare("GROUP") && str1.compare("NAME")
                    &&str1.compare("PRICE") && str1.compare("VARCOST") && str1.compare("PRICEFLEX")
    ...
    while (!ins.eof()){
        ...
        if (str1[0]=='!') {
            ...
            while ( is >> str1) {
                if (!(str1.compare("PRODUCTNAME") && str1.compare("A") && str1.compare("B")
                    &&str1.compare("C") && str1.compare("D") && str1.compare("GAMMA")
        ...
        while ( iss >> str1) {
             if ( yieldCols["PRODUCTNAME"] == j )
					...
					yield.dyn = str1.compare("true")==0 ? true: false;
    ...
    while (!ins.eof()){
        ...
        while ( iss >> str1) {
             if (investCols["TYPE"]==j)
                ...
                //ALS INT eingelesen wie in der alten Version
                ...
                //Christoph meinte landsub soll als int eingelesen werden
                    double t = atof(str1.c_str());
                    t =  t>0 ? t+0.5: t-0.5;
                    inv.labsub = int (t);
...
/*
//static
   void  readlink2(istringstream& is, onelink& cl){
        string str1;
        double d;
